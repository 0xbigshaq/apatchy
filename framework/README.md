...
```bash
apatchy fuzz --resume --output-dir out-afl-mod-crypt-1 \
...
apatchy fuzz --resume --role main --name main01 --output-dir out-afl-1 ...
```
...
```bash
# Terminal 2
apatchy fuzz --role secondary --name sec01 --output-dir out-afl-1 ...

# Terminal 3
apatchy fuzz --role secondary --name sec02 --output-dir out-afl-1 ...
```
...
```bash
# Terminal 1 - main
apatchy fuzz --role main --output-dir out-parallel ...

# Terminal 2 - secondary
apatchy fuzz --role secondary --name sec01 --output-dir out-parallel ...
```
